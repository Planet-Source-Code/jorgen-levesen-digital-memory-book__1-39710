...
Private Sub LoadDropDown1()
    'With rsCountry
        '.MoveFirst
        'Do While Not .EOF
            'DropDown1.AddItem .Fields("Country") & vbTab & .Fields("CountryFix")
        '.MoveNext
        'Loop
    'End With
End Sub
...
Private Sub Form_Load()
    ...
    Me.Move 0, 0
    rsColor.DatabaseName = dbKidsTxt
    Set rsCountry = dbKids.OpenRecordset("Country")
    Set rsLanguage = dbKidLang.OpenRecordset("frmColor")
    Exit Sub
...
Private Sub Grid1_Click()
    'On Error Resume Next
    'Picture1.BackColor = RGB(CLng(Grid1.Columns(2).Value), CLng(Grid1.Columns(3).Value), CLng(Grid1.Columns(4).Value))
    'H1.Value = CLng(Grid1.Columns(2).Value)
    'H2.Value = CLng(Grid1.Columns(3).Value)
    'H3.Value = CLng(Grid1.Columns(4).Value)
End Sub

Private Sub Grid1_InitColumnProps()
    'Grid1.Columns(0).DropDownHwnd = DropDown1.hWnd
End Sub
