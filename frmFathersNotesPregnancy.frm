...
Begin VB.Form frmFathersNotesPregnancy 
   BackColor       =   &H000080FF&
   ClientHeight    =   6645
   ClientLeft      =   60
   ClientTop       =   60
   ...
   Begin VB.Frame Frame1 
      BackColor       =   &H000080FF&
      Caption         =   "Fathers Pregnancy Notes for "
      Height          =   6375
      Left            =   120
      TabIndex        =   2
      Top             =   120
      ...
      Begin VB.Data rsPregnancyNotes 
         ...
         RecordSource    =   "FathersNotesPregnancy"
         Top             =   360
         Visible         =   0   'False
         Width           =   1140
      End
      Begin RichTextLib.RichTextBox RichText1 
         ...
         ScrollBars      =   2
         Appearance      =   0
         TextRTF         =   $"frmFathersNotesPregnancy.frx":0000
      End
   ...
   End
End
Attribute VB_Name = "frmFathersNotesPregnancy"
...
Public Sub NewPregnancyNotesFather()
    ...
    boolNewRecord = True
End Sub
Public Sub WriteFatherPregnancyNotesWord()
    On Error Resume Next
    WriteHeader (rsLanguage.Fields("FormName"))
    With wdApp
        rsPregnancyNotes.Recordset.MoveFirst
        Do While Not rsPregnancyNotes.Recordset.EOF
            If CLng(rsPregnancyNotes.Recordset.Fields("ChildNo")) = CLng(glChildNo) Then
                If IsDate(rsPregnancyNotes.Recordset.Fields("NoteDate")) Then
                    DoEvents
...
Public Sub WriteFatherPregnancyNotes()
    On Error Resume Next
...
Dim strHelp As String
    ...
    With rsLanguage
        ...
        .Fields("Label1(1)") = Label1(1).Caption
        .Fields("Frame1") = Frame1.Caption
        .Fields("FormName") = "Fathers Notes, Pregnancy"
        .Fields("sDate") = "Date: "
        .Fields("spage") = "Page: "
        .Fields("Help") = strHelp
        .Update
...
Dim Sql As String
    ...
    Sql = "SELECT * FROM FathersNotesPregnancy WHERE CLng(ChildNo) ="
...
Private Sub RichText1_SelChange()
    Call RichTextSelChange(frmFathersNotesPregnancy.RichText1)
End Sub
