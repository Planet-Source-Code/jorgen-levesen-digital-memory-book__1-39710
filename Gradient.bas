...
Private Declare Function GradientFillTri Lib "msimg32" Alias "GradientFill" (ByVal hDC As _
    Long, pVertex As TRIVERTEX, ByVal dwNumVertex As Long, pMesh As _
    GRADIENT_TRIANGLE, ByVal dwNumMesh As Long, ByVal dwMode As Long) As Long
Private Declare Function TransparentBlt Lib "msimg32.dll" (ByVal hdcDest As Long, ByVal _
    nXOriginDest As Long, ByVal nYOriginDest As Long, ByVal nWidthDest As Long, _
    ByVal nHeightDest As Long, ByVal hdcSrc As Long, ByVal nXOriginSrc As Long, _
    ByVal nYOriginSrc As Long, ByVal nWidthSrc As Long, ByVal nHeightSrc As Long, _
...
Private Declare Function InvalidateRect Lib "user32" (ByVal hWnd As Long, ByVal lpRect As _
...
Declare Function ValidateRectBynum& Lib "user32" Alias "ValidateRect" (ByVal hWnd As _
    Long, ByVal lpRect As Long)
