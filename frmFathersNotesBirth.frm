...
Begin VB.Form frmFathersNotesBirth 
   BackColor       =   &H00008000&
   ClientHeight    =   6525
   ClientLeft      =   60
   ClientTop       =   60
   ...
   Begin VB.Frame Frame1 
      BackColor       =   &H00008000&
      Caption         =   "Fathers Birth Notes for "
      ForeColor       =   &H00FFFFFF&
      Height          =   6255
      Left            =   120
      TabIndex        =   2
      ...
      Begin VB.Data rsBirthNotes 
         ...
         RecordSource    =   "FathersNotesBirth"
         Top             =   480
         Visible         =   0   'False
         Width           =   1140
      End
      Begin RichTextLib.RichTextBox RichText1 
         ...
         ScrollBars      =   2
         Appearance      =   0
         TextRTF         =   $"frmFathersNotesBirth.frx":0000
      End
   ...
   End
End
Attribute VB_Name = "frmFathersNotesBirth"
...
Public Sub NewFatherBirth()
    On Error Resume Next
    rsBirthNotes.Recordset.Move 0
    rsBirthNotes.Recordset.AddNew
    NoteDate.SetFocus
    boolNewRecord = True
End Sub


Public Sub WriteBirthNotesWord()
    On Error Resume Next
    WriteHeader (rsLanguage.Fields("FormName"))
    With wdApp
        rsBirthNotes.Recordset.MoveFirst
        Do While Not rsBirthNotes.Recordset.EOF
            If CLng(rsBirthNotes.Recordset.Fields("ChildNo")) = CLng(glChildNo) Then
                If IsDate(rsBirthNotes.Recordset.Fields("NoteDate")) Then
                    DoEvents
                    .Selection.TypeText Text:=Label1(1).Caption
                    .Selection.MoveRight Unit:=wdCell
                    .Selection.TypeText Text:=Format(CDate(rsBirthNotes.Recordset.Fields("NoteDate")), "dd.mm.yyyy")
                    .Selection.MoveRight Unit:=wdCell
                    .Selection.MoveRight Unit:=wdCell
                    Clipboard.Clear
                ...
                End If
            End If
        rsBirthNotes.Recordset.MoveNext
        Loop
    End With
    Set wdApp = Nothing
End Sub

Public Sub WriteBirthNotes()
    On Error Resume Next
...
SendToPrinter:
    ...
    With rsBirthNotes.Recordset
        .MoveFirst
        Do While Not .EOF
            If CLng(.Fields("ChildNo")) = CLng(glChildNo) Then
                If IsDate(.Fields("NoteDate")) Then
                    cPrint.FontBold = True
                    cPrint.pPrint Label1(1).Caption & "  " & Format(CDate(.Fields("NoteDate")), "dd.mm.yyyy"), 1, True
...
Dim strHelp As String
    ...
    With rsLanguage
        ...
        .Fields("Label1(1)") = Label1(1).Caption
        .Fields("Frame1") = Frame1.Caption
        .Fields("FormName") = "Fathers Notes, Birth"
        .Fields("sDate") = "Date: "
        .Fields("spage") = "Page: "
        .Fields("Help") = strHelp
        .Update
...
Dim Sql As String
    ...
    Sql = "SELECT * FROM FathersNotesBirth WHERE CLng(ChildNo) ="
    Sql = Sql & Chr(34) & CLng(glChildNo) & Chr(34)
    rsBirthNotes.RecordSource = Sql
    rsBirthNotes.Refresh
    SelectRecords = True
    Exit Function
...
Private Sub Form_Load()
    ...
    rsBirthNotes.DatabaseName = dbKidsTxt
...
Private Sub Form_Unload(Cancel As Integer)
    On Error Resume Next
    rsBirthNotes.Recordset.Close
    rsLanguage.Close
    HideAllButtons
    HideKids
    iWhichForm = 0
    Erase v2RecordBookmark
    Set frmFathersNotesPregnancy = Nothing
End Sub
...
Private Sub RichText1_SelChange()
    Call RichTextSelChange(frmFathersNotesBirth.RichText1)
End Sub
